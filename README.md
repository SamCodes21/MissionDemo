...
> &nbsp;
>https://samosh03.itch.io/mission-demolition   
> &nbsp;
...
> &nbsp;
>I added a button to restart level, it works but it fully restarts the level back to level 1, so if you're farther than level 1 it can be a nuisance.     
>     
> I also added additional materials such as steel walls that are harder to move, and a bouncy wall that is stationary and acts as a backboard for players shots (it's a pink wall).    
>     
> I added 4 different levels with them scaling in difficulty as each level goes on.    
> &nbsp;
...
> &nbsp;
>Yes, to create the code for the restart level button I found a helpful unity website that had the code in it, I just took it and applied it to the new button I made and then set up the code to attach to that button.     
>     
> Here's the link: https://discussions.unity.com/t/creating-a-restart-button/175658   
> &nbsp;
...
> &nbsp;
>I really wanted to add more enhancements but couldn't figure out how to add them.    
> &nbsp;
...
> &nbsp;
>When I play the WebGLBuild it removes all my assets and is just a blank screen. I don't know how to fix this but everything works as intended inside Unity.   
> &nbsp;
